...
CREATE TABLE `sys_user` (
  ...
  `emp_name` varchar(100) COMMENT '姓名',
...
-- 初始数据
INSERT INTO `sys_user` (`user_id`, `username`, `password`, `salt`, `email`, `mobile`, `status`, `dept_id`, `create_time`) VALUES ('1', 'admin', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', 'YzcmCZNvbXocrsz9dm8e', 'liujiangtao@sihuanpharm.com', '18310110262', '1', '1', '2022-01-01 11:11:11');
...
INSERT INTO `sys_dept` (`dept_id`, `parent_id`, `name`, `order_num`, `del_flag`) VALUES ('1', '0', '四环医药', '0', '0');
...
INSERT INTO `schedule_job` (`bean_name`, `params`, `cron_expression`, `status`, `remark`, `create_time`) VALUES ('testTask', 'sihuan', '0 0/30 * * * ?', '0', '参数测试', now());
...
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES ('0', '考勤管理', NULL, NULL, '0', 'fa fa-cog', '0');
