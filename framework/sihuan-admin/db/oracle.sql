...
-- 初始数据
INSERT INTO sys_user (user_id, username, password, salt, email, mobile, status, dept_id, create_time) VALUES ('1', 'admin', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', 'YzcmCZNvbXocrsz9dm8e', 'liujiangtao@sihuanpharm.com', '18310110262', '1', '1', CURRENT_DATE);
...
INSERT INTO schedule_job (job_id, bean_name, params, cron_expression, status, remark, create_time) VALUES (1, 'testTask', 'sihuan', '0 0/30 * * * ?', '0', '参数测试', CURRENT_DATE);
