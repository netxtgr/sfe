...
import io.sihuan.common.annotation.SysLog;
import io.sihuan.common.utils.PageUtils;
import io.sihuan.common.utils.R;
import io.sihuan.common.validator.Assert;
...
import io.sihuan.modules.sys.service.SysUserRoleService;
import io.sihuan.modules.sys.service.SysUserService;
import io.sihuan.modules.sys.shiro.ShiroUtils;
...
public class SysUserController extends AbstractController {
	...
	public void export(@RequestParam Map<String, Object> params, HttpServletRequest request, HttpServletResponse response){
		PageUtils page = sysUserService.queryPage(params);
		ExcelUtils.export(page.getList(), request, response, SysUserEntity.class);
	}
