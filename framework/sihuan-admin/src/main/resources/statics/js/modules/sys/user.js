$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
            ...
            { label: '姓名', name: 'empName', width: 75 },
            ...
            { label: '创建人', name: 'createdBy', index: "created_by", width: 85},
			{ label: '创建时间', name: 'createTime', index: "create_time", width: 85},
            { label: '更新人', name: 'updatedBy', index: "updated_by", width: 85},
...
var vm = new Vue({
    ...
    methods: {
        ...
        exportExcel: function (event) {
            ...
            if (vm.q.username && vm.q.username != null) {
