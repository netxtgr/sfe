...
package io.sihuan.utils;

import io.sihuan.entity.ColumnEntity;
import io.sihuan.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.sihuan" : mainPath;
